...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a101a] via-[#101826] to-[#181f2a] relative overflow-hidden">
      {/* Background Pattern */}
      <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg width=60 height=60 viewBox=0 0 60 60 xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cg fill=\'none\' fill-rule=\'evenodd\'%3E%3Cg fill=\'#9C92AC\' fill-opacity=\'0.03\'%3E%3Ccircle cx=30 cy=30 r=2/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] opacity-30 pointer-events-none"></div>
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-2 sm:px-4">
        ...
        >
          ...
          >
            <h1
              id="hero-title"
              className="text-4xl sm:text-6xl md:text-7xl font-bold text-white mb-4 leading-tight"
            >
              Have I Been{" "}
          ...
          >
            ...
            >
              ...
              <input
                id="email"
                type="email"
                className="flex-1 w-full bg-white/10 border border-white/20 text-white placeholder-gray-400 p-5 rounded-2xl text-lg focus:ring-2 focus:ring-blue-500 outline-none transition"
              ...
              <button
                type="submit"
                disabled={loading}
                className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 disabled:opacity-50 disabled:cursor-not-allowed text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 shadow-lg hover:shadow-xl"
              >
                {loading ? (
          ...
          {submitted && data && (
            <section
              className="w-full max-w-5xl mx-auto mb-8 px-2"
            ...
            >
              ...
              {data.breachedAccounts.length > 0 ? (
                <>
                  <div className="bg-red-900/20 border border-red-500/40 rounded-2xl p-8 text-center mb-8">
                    <span className="block text-5xl font-extrabold text-red-400 mb-2">
                      {data.breachedAccounts.length}
                    </span>
                    <span className="block text-2xl font-bold text-red-300 mb-2">
                      Data Breaches
                    </span>
                  ...
                  <aside
                    className="bg-blue-900/30 border border-blue-500/40 rounded-2xl p-8 flex flex-col sm:flex-row items-center justify-between mb-8"
                  ...
                  >
                    ...
                    <button className="mt-4 sm:mt-0 px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded transition-colors">
                      Notify Me
                    </button>
                  </aside>
                </>
              ) : (
                <div className="bg-green-900/20 border border-green-500/40 rounded-2xl p-8 text-center mb-8">
                  <span className="block text-5xl font-extrabold text-green-400 mb-2">
                    0
                  </span>
                  <span className="block text-2xl font-bold text-green-300 mb-2">
                    Data Breaches
                  </span>
          ...
          {/* Timeline */}
          <section
            className="w-full max-w-6xl mx-auto mb-8 px-2"
          ...
          >
            <div className="flex-1 bg-blue-900/30 border border-blue-500/40 rounded-lg p-6 flex flex-col items-center shadow">
